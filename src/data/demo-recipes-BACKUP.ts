...
export const DEMO_RECIPES: Recipe[] = [
  // === DEUTSCHE KLASSIKER ===
  {
    ...
    url: 'https://www.chefkoch.de/rezepte/567571148823373/Sauerbraten.html',
    source: 'chefkoch',
    rating: 4.8,
    reviewCount: 2847,
    cookTime: 240,
  ...
  },
  {
    ...
    url: 'https://www.chefkoch.de/rezepte/1658681251908046/Spaghetti-Bolognese.html', 
    source: 'chefkoch',
    rating: 4.6,
    reviewCount: 3247,
    cookTime: 45,
  ...
  },
  {
    ...
    url: 'https://www.chefkoch.de/rezepte/3445571457885790/Schnitzel-Wiener-Art.html',
    source: 'chefkoch',
    rating: 4.7,
    reviewCount: 1834,
    cookTime: 20,
